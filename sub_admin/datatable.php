...
<head>
  ...
  <title>FYNDAH - Data Tables</title>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="sub-header">
                ...
                that will interact with a DataTable. The core library provides the based framework upon which plug-ins
                can built.
              </p>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              ...
              <p class="sub-header">
                This example shows the multi option. Note how a click on a row will toggle its selected state without
                effecting other rows,

...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 30, 2022 at 03:00 AM
...
DROP TABLE IF EXISTS `customerlikes`;
CREATE TABLE IF NOT EXISTS `customerlikes` (
  `id` int(11) NOT NULL,
  `text` text NOT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `customerscomment`;
CREATE TABLE IF NOT EXISTS `customerscomment` (
  `id` int(11) NOT NULL,
...
(9, 'madmin', 'madmin@gmail.com', 'ed775fc7100d30f0ff6c1dbff1a6fb11f349a17a', '1994-12-06', '1470002569'),
(9, 'madmin', 'madmin@gmail.com', 'ed775fc7100d30f0ff6c1dbff1a6fb11f349a17a', '1994-12-06', '1470002569'),
(9, 'madmin', 'madmin@gmail.com', 'ed775fc7100d30f0ff6c1dbff1a6fb11f349a17a', '1994-12-06', '1470002569'),
(9, 'madmin', 'madmin@gmail.com', 'ed775fc7100d30f0ff6c1dbff1a6fb11f349a17a', '1994-12-06', '1470002569');
...
(147, 'Land for sale', 0, 0, 0, 0, 0, 15000000, '', 'Katampe Extensio, Diplomatic Zone Abuja ', '', 'IMG-20220929-WA0003.jpg', 'â€¼ï¸PROMO on FCDA approved Estate plots @ Katampe Extension Diplomatic Zone Abuja\r\nâ˜Žï¸Call /WhatsApp \r\n 08064327140    09073741175â€¼ï¸\r\nðŸŽ†CURRENT PRICE: Promo \r\n300SQM  @ 9Million\r\n500SQM @15Million\r\n800SQM @35Million', '', 'Private ', 'Land ', '', 'No', '', '2022-10-01 19:56:10', 'IMG-20220929-WA0006.jpg', 'IMG-20220929-WA0004.jpg', 'IMG-20220929-WA0005.jpg', 2, 'User', 0, '', 'sell', '', '', '', '', '', '', 1),
(148, 'newj', 2, 3, 3, 2, 1, 6970000, '2', 'Extensio, Diplomatic Zone Abuja', '', 'img2.jpg', '', '', 'hector', 'land', 'alot', 'No', '', '2022-10-02 08:28:03', 'img3.jpg', 'img1.jpg', 'img2.jpg', 1, 'SuperAdmin', 0, '', 'rent', '', '', '', '', '', '', 1),
...
(195, 'C Of O', 0, 0, 0, 0, 0, 25000000, '', 'New garage, challenge, Ibadan', '', 'Screenshot_20221013-101408~2.png', '', '', 'R. E. E', '3bedroom bungalow', '', 'yes', '', '2022-10-13 05:32:53', 'Screenshot_20221013-101720~2.png', 'Screenshot_20221013-101637~2.png', 'Screenshot_20221013-101038.png', 69, 'User', 0, '', '', '', '', '', '', '', '', 0),
...
--
ALTER TABLE `sub_admins`
  MODIFY `id` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=202;

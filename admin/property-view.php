...
<?php 
    // pass web-site url
    $site_url  = "http://127.0.0.1:8000/admin/property-view.php";
    // post title
    $site_title  = "fyndah.com";
?>
              ...
              <div class="col-12">
               ...
               $i=1;
					//		$id=$_SESSION['user_id'];
					    ...
					    $sql="SELECT * FROM `property` ORDER BY `property`.`id` DESC ";
             ...
             $img=$row['image1'];
						?> <td><?php echo $i++; ?></td>
                            ...
                            <td><a href="property-edit.php?id=<?php echo $id;?>"><button
                              ...
                              <a href="property-boost.php?id=<?php echo $id;?>"><button
                                  class="btn btn-primary">Boost</button></a>

                              <!-- Buffer Social Media -->
                              <a href="https://bufferapp.com/add?url=<?=$site_url?>&amp;text=<?=$site_title?>"
                                target="_blank">
                                <img src="http://www.onlinecode.org/example/images/buffer.png"
                                  alt="Buffer share link" />
                              </a>
